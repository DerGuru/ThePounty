# Aldric Venn — Figurensystem
*Nebencharaktere · Ebenen · Funktionen · Stand: laufend*

---

## Die Grundregel

Jeder Charakter hat genau eine Funktion: Er zeigt eine Facette von Aldric, die kein anderer zeigen kann.

Sobald zwei Charaktere dasselbe sehen — ist einer überflüssig.

---

## Die drei Regeln für alle Nebencharaktere

1. **Jeder sieht einen anderen Aldric.** Sobald zwei dasselbe sehen, ist einer überflüssig.
2. **Jeder hat einen eigenen Ton.** Dave denkt anders als Gerald. Gerald anders als Ms. Yuen. Das ist keine Stilübung — das ist Struktur.
3. **Stammcharaktere verändern sich. Episodenfiguren nicht.** Das ist der Unterschied zwischen Arc und Funktion.
...
### Dave Ortega
**Rolle:** Der Freund, der es nicht merkt
**Funktion:** Der Normalmaßstab. Durch ihn sieht der Leser, wie „normal" auf Aldric reagiert.

| Eigenschaft | Beschreibung |
|---|---|
| Ton | Kurze Sätze. Praktisch. Gutmütig. Denkt nicht zu viel nach. |
| Sein Aldric | „Seltsamer Typ. Aber er meint es gut. Glaube ich." |
| Arc | Beginnt neugierig → endet als echter Freund, ohne den Moment zu kennen, wann es passiert ist. |

Dave bemerkt Dinge, ohne sie einzuordnen. Der Leser ordnet sie ein. Das ist seine Stärke als POV.

Er stellt beim Kistentragen sieben Fragen in drei Kisten. Er bekommt vollständige, freundliche, detaillierte Antworten — und erfährt nichts.

---

### Rosa Ortega
**Rolle:** Die stille Beobachterin
**Funktion:** Die emotionale Linse. Sie fühlt, was andere analysieren.

| Eigenschaft | Beschreibung |
|---|---|
| Ton | Warm, detailreich, denkt in Fürsorge. Bemerkt was fehlt, nicht was da ist. |
| Ihr Aldric | „Er ist es gewohnt, allein zu sein. Das macht mich traurig. Ihn nicht." |
| Arc | Beginnt mit Mitleid → endet mit Respekt. Lernt, dass er keine Fürsorge braucht — aber vielleicht Gesellschaft. |

Der leere Rahmen. Sie sieht ihn am ersten Tag. Sie erwähnt ihn nie. Aber sie denkt noch im letzten Kapitel daran.

Sie macht am Einzugstag mehr Essen als geplant. Sagt nichts dazu. Das ist ihr Charakter in einer Handlung.
...
Gerald hat am Ende mehr über Aldric herausgefunden als alle anderen. Er versteht trotzdem am wenigsten — weil er die falschen Fragen gestellt hat.

Er glaubt, er hat Aldric im Visier. Er merkt nie, dass es andersherum ist.

Am Einzugstag trägt er eine Kiste — die leichteste — und nutzt die Zeit, den Anhänger vollständig zu inventarisieren.

Seine Notizen sind ein Running Gag und ein Erzählmittel zugleich. Der letzte gestrichene Satz vom Einzugstag:
...
### Ms. Yuen
**Rolle:** Die Zeugin
**Funktion:** Das Gewissen der Straße. Ihr POV ist selten — aber wenn er kommt, trifft er.

| Eigenschaft | Beschreibung |
|---|---|
| Ton | Ruhig. Wenige Worte. Beobachtungen, die mehr enthalten als sie aussprechen. |
| Ihr Aldric | „Er hat etwas getan, das ihn hierher gebracht hat. Er hat auch etwas verloren. Beides sieht man, wenn man weiß, wo man hinschaut." |
| Arc | Kein klassischer Arc — sie verändert sich kaum. Sie ist der Spiegel, der zeigt, wie die Straße sich verändert hat. |

Sie sagt das nie laut. Sie denkt es einmal, in einem einzigen Satz, in ihrem einzigen langen POV-Kapitel. Das reicht.

Sie bringt am Einzugstag nichts. Sie beobachtet wie er den Dankesbrief übergibt. Nickt einmal. Entscheidet: der bleibt.

---

### Sandra Hooper
**Rolle:** Die Neugierige
**Funktion:** Die Komik-Linse. Ihr Suchen nach Geheimnissen — und ihr Nichts-Finden — ist eine der Hauptkomödienquellen.

| Eigenschaft | Beschreibung |
|---|---|
| Ton | Aktiv, etwas aufgeregt, denkt in Verdächtigungen die sich nicht bewahrheiten. |
| Ihr Aldric | „Da muss mehr sein. Da MUSS mehr sein." |
| Arc | Sie findet nie das Geheimnis. Sie findet stattdessen: drei beschriftete Gewürzgläser und einen Mann, der Dankesbriefe schreibt. Das frustriert sie zutiefst. |

Sie bringt am Einzugstag einen Auflauf und bleibt in der Küche. Öffnet dabei jeden Schrank, um „zu zeigen, wo was ist". Findet: nichts Ungewöhnliches.

Die Komik: Sie ist die aktivste Nachforscherin — und die mit den wenigsten Ergebnissen. Gerald findet zumindest heraus, dass der Name nicht in der Datenbank ist. Sandra findet beschriftete Gewürzgläser.
...
### Hund von Nr. 7
**Rolle:** Das Urteil ohne Worte
**Funktion:** Das intuitive Urteil. Tiere lügen nicht.

| Eigenschaft | Beschreibung |
|---|---|
| Name | Bekommt keinen. Das ist Absicht. |
| Regel | Bellt alle an. Bellt Aldric nicht an. |
| Funktion | Taucht auf, wenn die Straße über Aldric urteilt. Korrigiert stillschweigend. |

Er bellt Aldric nicht an. Niemand weiß warum. Aldric weiß es auch nicht. Er findet es trotzdem nett.

Das ist die ehrlichste Charakterbeschreibung im Buch — und sie kommt von einem Hund.

---

### Officer Kim
**Rolle:** Das System
**Funktion:** Die einzige Figur mit institutioneller Macht. Ihr Misstrauen hat eine andere Qualität als Geralds — es ist offiziell, nicht privat.

| Eigenschaft | Beschreibung |
|---|---|
| Ton | Präzise, professionell, aufmerksam. Denkt in Lücken und fehlenden Daten. |
| Ihr Aldric | „Er beantwortet jede Frage. Vollständig. Höflich. Und ich weiß danach weniger als vorher." |
| Arc | Beginnt mit Routine-Misstrauen → erkennt, dass er kein Krimineller ist, aber auch kein normaler Bürger → akzeptiert, dass es Menschen gibt, die in kein Formular passen. |

Streifenpolizistin. Aufgeweckt, gründlich. Aldric beantwortet jede ihrer Fragen vollständig, höflich und präzise — was ihre Arbeit nicht einfacher macht, weil vollständige Antworten selten das sind, was man erwartet.

Sie ist nicht sein Feind. Sie ist sein Gegenüber in einem System, das er respektiert, ohne ihm zu vertrauen.

---

## Ebene 2 — Wiederkehrende Figuren
...
## Ebene 3 — Episodenfiguren

*Eine Episode · eine Begegnung · ein Prinzip · danach verschwunden*

Sie kommen, demonstrieren ein Prinzip von Aldric, und verschwinden wieder. Manchmal kehren sie als stilles Echo zurück — jemand, der ihn auf der Straße grüßt, ohne dass erklärt wird, woher er ihn kennt.

| Figur | Prinzip das sie demonstrieren |
|---|---|
| Der Taschendieb vom Parkplatz | Gleiches mit Gleichem — ohne Gewalt |
| Der Betrüger vom Markt | Spiegelung durch Wahrheit |
| Der Mann mit dem Messer | Anpassung in Echtzeit |
| Der wütende Nachbar von zwei Straßen weiter | Einmalige Chance, aufrichtig gemeint |
| Der Immobilienmakler | Präzisions-Höflichkeit in Extremform |
| Die Jugendlichen vom Park | Aldrics Verhältnis zu Unbesonnenheit vs. echter Gefahr |

### Die stille Rückkehr

Der schönste Trick: Episodenfiguren, die Aldric Wochen später auf der Straße grüßen — ohne Erklärung, woher sie sich kennen. Der Leser weiß es. Aldric grüßt zurück. Das Konto ist null.

> *Dave sah, wie der Mann mit der Narbe am Kinn auf Aldric zuging und kurz nickte. Aldric nickte zurück. Beide gingen weiter.*
>
> *„Wer war das?"*
>
> *„Ein Bekannter," sagte Aldric.*
>
> *Dave wartete auf mehr. Es kam nichts mehr.*

---

## Die Figurenübersicht

| Name | Ebene | POV | Arc | Funktion |
|---|---|---|---|---|
| Dave Ortega | 1 | Ja | Ja | Normalmaßstab |
| Rosa Ortega | 1 | Ja | Ja | Emotionale Linse |
| Gerald Hooper | 1 | Ja | Ja (Haupt-Arc) | Lernbogen des Buches |
| Ms. Yuen | 1 | Selten, gewichtig | Nein | Zeugin / Spiegel |
| Sandra Hooper | 1 | Gelegentlich | Nein | Komik-Linse |
